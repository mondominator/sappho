...
export default function LibrarySettings() {
  ...
  return (
    <div className="tab-content library-settings">
      ...
      <div className="info-box" style={{ marginTop: '2rem', background: '#1e3a5f', borderColor: '#3b82f6' }}>
        <h4>Library Management</h4>
        <p style={{ color: '#93c5fd' }}>
          Looking for scan, reorganize, or refresh options? These have been moved to the <strong>Jobs</strong> tab for better organization.
        </p>
      </div>
    </div>
  );
